...
class BoxAnnotator:
    ...
    def annotate(
        ...
        font_size = max(round(max(image.size) / 40), 12)
        font = ImageFont.truetype("/content/Yekan.ttf", font_size)
        print(f"{font = }")
        ...
        for i in range(len(detections)):
            ...
            # draw.rectangle(xy=[text_background_x1, text_background_y1,text_background_x2, text_background_y2],
            # fill=(255, 255, 255))
            ...
            # draw.text(
            #     (text_x, text_y), text, fill=(0,0,255), font=font
            # )
